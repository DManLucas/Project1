    ...
    public static class SectionExtensions
    {
            ...
            int productId, int sectionId, int itemTypeId, string userId, ApplicationDbContext db = null)
        {
            ...
            var items = await (from i in db.Items
                               ...
                               join us in db.UserSubscriptions on sp.SubscriptionId equals us.SubscriptiontId
                               ...
                               select new ProductItemRow
                               {
                                   ...
                                   today.Day, 0, 0, 0) >= DbFunctions.CreateDateTime(us.StartDate.Value.Year, us.StartDate.Value.Month,
                                   us.StartDate.Value.Day + i.WaitDays, 0, 0, 0),
                               }).ToListAsync();
